  ...
  return (
    <>
      ...
      {!hasStarted ? (
        ...
        // HOME SCREEN
        // ==========================================
        <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center text-white relative overflow-hidden p-8" style={{ overflowAnchor: 'none' }}>
          <AboutModal />
                    ...
                    <div className="w-full max-w-2xl mx-auto my-12 bg-slate-950/80 border border-slate-700/50 rounded-2xl overflow-hidden shadow-[0_0_30px_rgba(0,0,0,0.8)] p-6 md:p-8 flex flex-col justify-center text-center">
                      ...
                      <div className="mt-8 pt-6 border-t border-slate-800">
                        ...
                        <p className="text-sm md:text-base text-slate-300 leading-relaxed max-w-lg mx-auto text-left">
                          Against global streaming data, the odds of your chosen track surviving the gauntlet to take the crown were <span className="font-black text-[#ff00ff]">{displayGauntletProb}%</span>.
                        </p>
                      </div>
                    </div>
                  );
